...
public enum ErrorStatus implements BaseErrorCode {
    ...
    INVALID_PASSWORD(HttpStatus.UNAUTHORIZED, "MEMBER4003", "잘못된 비밀번호입니다"),
    ...
    MISSION_ALREADY_COMPLETE(HttpStatus.BAD_REQUEST, "MISSION4003", "이미 완료된 미션입니다."),
    MISSION_NOT_IN_PROGRESS(HttpStatus.BAD_REQUEST, "MISSION4004", "진행 중인 미션이 아닙니다."),
