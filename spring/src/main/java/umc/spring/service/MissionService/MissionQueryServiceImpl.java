...
public class MissionQueryServiceImpl implements MissionQueryService {
    ...
    public Page<Mission> getStoreMissionList(Long storeId, Integer page) {
        ...
        return missionRepository.findAllByStoreOrderByCreatedAtDesc(
                store, PageRequest.of(page - 1, 10)
        );
    }
    ...
    public Page<MemberMission> getMyMissionList(Long memberId, Integer page) {
        ...
        return memberMissionRepository.findAllByMemberAndStatusOrderByCreatedAtDesc(
                member, MissionStatus.CHALLENGE, PageRequest.of(page - 1, 10)
        );
    }
